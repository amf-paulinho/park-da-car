class ParkingsController < ApplicationController
  ...
  def checkvin
    respond_to do |format|
      format.json { render json: check_vin(params[:id]), status: :ok }
    end
  end
  ...
  def destroy
    ...
    respond_to do |format|
      ...
      #format.json { render json: Parking.all, status: :ok }
  ...
  private
    ...
    def parking_params
      params.require(:parking).permit(:clientname, :clientaddress, :clientphone, :carvin, :caryear, :carmake, :carmodel, :cartrim, :carplate, :checkintime, :checkouttime, :checkinatt, :checkoutatt, :facilityspot, :facilityname, :facilityaddress)
    end
end
